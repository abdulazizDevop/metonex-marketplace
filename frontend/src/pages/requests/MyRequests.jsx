...
import { getMyRequests, closeRequest } from '../../utils/api.js'
...
export default function MyRequests() {
  ...
  async function loadRequests() {
    try {
      ...
      const data = await getMyRequests(params.toString())
  ...
  async function handleCloseRequest(id) {
    if (!confirm('Bu so\'rovni yopishni xohlaysizmi?')) return
    ...
    try {
      ...
      console.error('So\'rovni yopishda xato:', error)
      alert('So\'rovni yopishda xato yuz berdi')
    }
  }
