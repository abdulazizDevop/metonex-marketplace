...
import { getBuyerOrders } from '../../utils/api';
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="flex items-center justify-between mb-6">
          <h1 className="text-2xl font-bold text-gray-900">Mening buyurtmalarim</h1>
        </div>
          ...
          {loading ? (
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                          <div>
                            ...
                            <span className="ml-1 font-medium">
                              {order.supplier_company_name || order.supplier_company?.name || '-'}
                            </span>
                          </div>
            ...
            <div className="p-12 text-center">
              ...
              <p className="mt-1 text-sm text-gray-500">
                {activeTab === 'all' 
                  ? 'Hozircha yaratilgan buyurtmalar yo\'q'
                  : `${tabs.find(t => t.id === activeTab)?.label} statusidagi buyurtmalar yo'q`
                }
              </p>
            </div>
          )}
