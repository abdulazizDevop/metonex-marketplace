  ...
  const [profileData] = useState({
    ...
    fiveStarReviews: [
      ...
      },
      {
        ...
        date: '1 month ago',
        rating: 5,
        comment: 'A pleasure to do business with. Everything was perfect from start to finish.'
      },
      {
        author: 'Anonymous',
        date: '2 months ago',
                  ...
                  <tbody>
                    {profileData.reviews.map((review, index) => (
                      <tr 
                        ...
                        onClick={() => handleReviewClick(review.rating)}
                      >
        ...
        <div className="absolute inset-0 z-20 flex flex-col bg-gray-50">
          ...
          <main className="flex-1 overflow-y-auto p-4">
            <div className="space-y-4">
              {selectedRating === 5 ? (
                profileData.fiveStarReviews.map((review, index) => (
                ...
                <div className="text-center py-8">
                  <p className="text-gray-500">No {selectedRating}-star reviews available</p>
                </div>
              )}
            </div>
          </main>
...
export default SellerProfileDetails2;