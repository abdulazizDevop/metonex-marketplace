...
const UploadInvoice = () => {
  ...
  const handleSubmit = () => {
    ...
    navigate('/documents-ready-for-payment')
  }
  ...
  return (
    <div className="min-h-screen bg-gray-50" style={{ fontFamily: 'Inter, sans-serif' }}>
      ...
      <div className="p-6 space-y-6">
        ...
        {/* Upload Area */}
        <div className="bg-white rounded-2xl p-6 shadow-sm">
          <h2 className="text-lg font-bold text-gray-900 mb-4">Upload Invoice Documents</h2>
          ...
          >
            ...
            <p className="text-gray-600 mb-4">
              Upload invoice PDF, images, or other documents
            </p>
            <button
          ...
          <div className="mt-4 p-4 bg-blue-50 rounded-xl">
            ...
            <ul className="text-sm text-blue-800 space-y-1">
              ...
              <li>• Clear, readable documents preferred</li>
            </ul>
          </div>
        </div>
                  ...
                  <div className="flex items-center space-x-3">
                    <div className="w-10 h-10 bg-purple-100 rounded-lg flex items-center justify-center">
                      <span className="material-symbols-outlined text-purple-600">
                        {fileObj.type.includes('pdf') ? 'picture_as_pdf' : 'description'}
                      </span>
                    </div>
                    <div>
