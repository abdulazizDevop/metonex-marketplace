    ...
    <div className="flex flex-col min-h-screen bg-white" style={{ fontFamily: 'Inter, sans-serif' }}>
      ...
      <header className="relative bg-gradient-to-b from-purple-600 to-blue-600 pt-16 pb-12 text-white">
        ...
        <div className="flex flex-col items-center justify-center px-6">
          ...
          <h1 className="text-3xl font-bold">Preparing Shipment</h1>
          <p className="mt-2 text-base text-white/80">Your order is being prepared at the warehouse.</p>
        </div>
      </header>
      ...
      <main className="flex-1 bg-white p-6">
        <div className="relative pl-6">
          ...
          <div className="relative flex items-start mb-8">
            ...
            <div className="ml-4 pt-3">
              <p className="font-semibold text-lg text-purple-600">Preparing Shipment</p>
            </div>
          </div>
          ...
          <div className="relative flex items-start mb-8">
            <div className="z-10 flex items-center justify-center w-14 h-14 rounded-full bg-gray-200">
              <span className="material-symbols-outlined text-gray-500 text-3xl">local_shipping</span>
            </div>
            <div className="ml-4 pt-3">
              <p className="font-semibold text-lg text-gray-500">In Delivery</p>
            </div>
          </div>
...
export default PreparingShipment2
